...
{
	public class DeleteCurrencyContentInputHandlerTests
	{

		private readonly IContentRepository _contentRepository;
		private readonly DeleteCurrencyContentInputHandler _handler;

		public DeleteCurrencyContentInputHandlerTests()
		{
			_contentRepository = Substitute.For<IContentRepository>();
			_handler = new DeleteCurrencyContentInputHandler(_contentRepository);
		}
		...
		{
			// Arrange
			var request = new DeleteCurrencyContentInput
			{
			...
			_contentRepository.DeleteContentAsync(Arg.Any<DeleteContentInput>()).Returns(true);
